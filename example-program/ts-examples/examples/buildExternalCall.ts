...
import { createTransferInstruction, createAssociatedTokenAccountIdempotentInstruction, getAssociatedTokenAddressSync } from "@solana/spl-token";
...
export function buildTransferExtCall(claimMint: PublicKey, destinationWallet: PublicKey) {
    ...
    const initAtaIx = createAssociatedTokenAccountIdempotentInstruction(submissionAuthPlaceholder, submissionAuthATA, submissionAuthPlaceholder, claimMint);
    extIx.push(
